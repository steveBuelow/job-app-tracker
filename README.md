...
* **Job Filtering:** Filter through applied/interviewing/no response for maximum productivity

* **Follow-up Reminders:** SQL query checks for applications created >7 days ago and displays a follow-up reminder at the top
